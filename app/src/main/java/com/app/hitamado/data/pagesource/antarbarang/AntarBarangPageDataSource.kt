...
class AntarBarangPageDataSource @Inject constructor(private val remoteDataSource: RemoteDataSource):PageKeyedDataSource<Int,DataItem>(){
    ...
    override fun loadInitial(
        ...
        remoteDataSource.loadAntarBarang(listAntarBarangCallback = object : RemoteDataSource.ListAntarBarangCallback{
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, DataItem>) {
        ...
        remoteDataSource.loadAntarBarang(page = params.key,listAntarBarangCallback = object :RemoteDataSource.ListAntarBarangCallback{
            override fun onSuccess(barang: Barang) {
